#!/usr/bin/env python3
"""
Test to verify the layout fix works
"""
...
def test_layout_fix():
    """Test that the layout fix resolves the itemAtPosition error"""
    ...
    try:
        ...
        # Test that the label attributes exist
        label_attrs = ['asset_type_lbl', 'asset_name_lbl', 'department_lbl', 'custom_dept_lbl']
        missing_labels = []
        ...
        if missing_labels:
            print(f"Missing label attributes: {missing_labels}")
            return False
        
        print("All label attributes exist!")
        
        # Test the visibility update method
        print("Testing _update_asset_filter_visibility method...")
        try:
            manager._update_asset_filter_visibility()
            print("Visibility update method works!")
        except Exception as e:
            print(f"Error in visibility update: {e}")
            return False
...
def main():
    ...
    print("\n" + "=" * 50)
    if success:
        print("SUCCESS: Layout fix is working!")
        print("The itemAtPosition error should be resolved.")
    else:
        print("FAILED: Layout fix has issues.")
