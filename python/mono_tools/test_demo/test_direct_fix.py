#!/usr/bin/env python3
"""
Direct test of File Manager fixes without package imports
"""

import os
import sys

# Add the file_manager directory to Python path
file_manager_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'file_manager')
sys.path.insert(0, file_manager_dir)

def test_direct_import():
    """Test direct import of file manager components"""
    print("Testing direct import of File Manager components...")
    ...
    try:
        ...
        # Import the file manager components directly
        print("Importing file manager helpers...")
        from file_manager_helpers import collect_asset_files, list_asset_types, list_asset_names, list_departments
        print("Helpers imported successfully!")
        
        print("Importing file manager models...")
        from file_manager_models import AssetTableModel
        print("Models imported successfully!")
        
        print("Importing file manager manager...")
        ...
        # Test that the asset filtering methods exist
        asset_methods = [
            '_init_asset_filtering', '_reload_asset_types', '_reload_asset_names',
            '_reload_departments', '_update_asset_filter_visibility',
            '_on_asset_type_changed', '_on_asset_name_changed', '_on_department_changed',
            '_on_custom_department_changed'
        ]
...
def main():
    """Main test function"""
    print("Testing File Manager Direct Import and Creation...")
    print("=" * 60)
